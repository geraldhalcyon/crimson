    ...
    <section className='mt-[87px] min-h-[200px] m-w-[100%] relative'>
      <div className={`overflow-hidden bg-[#f5f5f5] relative ${styles.bannerContainer}`}>
        ...
        className={`overflow-hidden md:absolute left-0 ${styles.bannerVideo}`}
          ...
          scrolling="no"
          title='banner video'
          src="https://sunishsadasivan.hippovideo.io/video/embed/LDkuGaDtcqQja1LrnZ12p9bpm1rlm_xzovd-KwfzXD0?org_tok=EkftNVDFrILIkMQrfCy1vQ&amp;autoplay=true&amp;loop=true&amp;controls=false">
        </iframe>
